...
for i,l in enumerate(numbers):
    mapping_numbers[l] = i
mapping_numbers = {v:k for k,v in mapping_numbers.items()}
...
model = keras.models.load_model(r"model\model3.h5")
# model = keras.Model.load_weights(r"..\team-20\model\model.h5")
# model = load_model(filepath=r"..\team-20\model\model1.h5")

# load json and create model
# json_file = open("team-20\model\model (1).json", "r")
